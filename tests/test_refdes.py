...
from refdes import keys as keys_mod  # noqa: E402
...
# ------------------------------------------------------------------------- keys
#
# docs/design/keys.md: opaque, immutable surrogate identity. This slice covers
# §1 (key format) and the minting half of §2 only -- link resolution, hashing,
# the corruption lint, and adoption are later layers, not implemented here.

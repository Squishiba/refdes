...
graph LR
  ...
  constraint -- derives_from --> requirement
  constraint -- derives_from --> constraint
...
|---|---|---|
| `refines` | `refined_by` | a requirement narrowing another requirement |
| `derives_from` | `derived_by` | a constraint derived from a requirement or another constraint |
| `satisfies` | `satisfied_by` | decision or component → requirement |
| `constrained_by` | `constrains` | decision → constraint |
| `verifies` | `verified_by` | test → requirement or constraint |
